...
<div id="hero-phn">
  ${h.mediaType === 'video'
    ? `<video class="hero-bg hero-bg--desktop" id="hero-video-desktop" autoplay loop playsinline preload="auto"><source src="${e(h.videoUrl || 'assets/video3.mp4')}" type="video/mp4" /></video>`
    : `<img class="hero-bg hero-bg--desktop" src="${e(h.imageUrl || 'assets/imagen1.webp')}" alt="" />`}
  <video class="hero-bg hero-bg--mobile" autoplay muted loop playsinline>
    <source src="assets/movil.mp4" type="video/mp4" />
  </video>
...
<section id="section-experiences" class=" ct-section">
  ...
  function buildTestimonials() {
    ...
    const images = [
      'reseñas/reseña1.webp',
      'reseñas/reseña2.webp',
      'reseñas/reseña3.webp',
      'reseñas/reseña4.webp',
      'reseñas/reseña5.webp',
    ];
...
<section id="section-contacto" class="ct-section">
  <style>
    #section-contacto {
      padding: 100px 40px;
      background: url('assets/contactos.jpeg') center center / cover no-repeat;
      position: relative;
    }
    ...
    html.dark #section-contacto { background: url('assets/contactos.jpeg') center center / cover no-repeat !important; }
  ...
  function buildInfoSection() {
    ...
    const socialIcons = {
      fb: 'assets/logos/redes/facebook.svg',
      yt: 'assets/logos/redes/youtube.svg',
      ig: 'assets/logos/redes/instagram.svg',
      wa: 'assets/logos/redes/whatsapp.svg',
      tt: 'assets/logos/redes/tiktok.svg',
      tw: 'assets/logos/redes/x.svg',
      em: 'assets/logos/redes/gmail.svg',
    };
    ...
    <div class="faq-layout">
      ...
      <div class="faq-img-col">
        <div class="faq-slideshow" id="faq-slideshow">
          <div class="faq-slide active"><img src="Preguntas/imagen1.webp" alt="Pregunta 1" /></div>
          <div class="faq-slide"><img src="Preguntas/imagen2.webp" alt="Pregunta 2" /></div>
          <div class="faq-slide"><img src="Preguntas/imagen3.webp" alt="Pregunta 3" /></div>
          <div class="faq-slide"><img src="Preguntas/imagen4.webp" alt="Pregunta 4" /></div>
          <div class="faq-slide"><img src="Preguntas/imagen5.webp" alt="Pregunta 5" /></div>
          <div class="faq-dots">
        ...
        <div class="faq-thumbs" id="faq-thumbs">
          <button class="faq-thumb active" data-idx="0"><img src="Preguntas/imagen1.webp" alt="Pregunta 1" /></button>
          <button class="faq-thumb" data-idx="1"><img src="Preguntas/imagen2.webp" alt="Pregunta 2" /></button>
          <button class="faq-thumb" data-idx="2"><img src="Preguntas/imagen3.webp" alt="Pregunta 3" /></button>
          <button class="faq-thumb" data-idx="3"><img src="Preguntas/imagen4.webp" alt="Pregunta 4" /></button>
          <button class="faq-thumb" data-idx="4"><img src="Preguntas/imagen5.webp" alt="Pregunta 5" /></button>
        </div>
      </div>
    </div>
  </div>
